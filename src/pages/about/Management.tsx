          ...
          <main className="flex-1">
            <div className="bg-gradient-to-br from-gray-900 to-black border border-yellow-500/20 rounded-xl p-8 lg:p-12">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-12">
                Meet the experienced professionals who lead ANTCLLC with vision, expertise, and commitment to excellence. Our management team brings together decades of industry knowledge and a shared passion for building world-class infrastructure.
              </p>

              <div className="grid md:grid-cols-2 gap-8">
                {teamMembers.map((member, index) => (
                  <div key={index} className="group bg-gradient-to-br from-black to-gray-900 border border-yellow-500/20 rounded-xl overflow-hidden hover:border-yellow-500/50 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex space-x-3">
                        <a href="#" className="bg-yellow-500/10 hover:bg-yellow-500 text-yellow-500 hover:text-black p-2 rounded-lg transition-all">
